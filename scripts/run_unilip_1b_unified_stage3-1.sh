...
export WANDB_NAME="unilip_intern_vl_1b_sft_alignment_distill05_D6_dynamic6"
...
# Dynamic Token-Level Layer Routing：从LLM多层提取特征，词元级自适应加权融合
ENABLE_DYNAMIC_ROUTING=True
ROUTING_NUM_LAYERS=6
...
torchrun --nproc_per_node=8 --nnodes=$WORLD_SIZE --node_rank=$RANK --master_port=$MASTER_PORT --master_addr=$MASTER_ADDR \
    ...
    --routing_num_layers ${ROUTING_NUM_LAYERS} \
