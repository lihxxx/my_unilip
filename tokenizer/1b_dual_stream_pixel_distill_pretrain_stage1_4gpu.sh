...
config_file=./configs/training/InternVL3_1B_DCAE/internvl3_1B_dual_stream_pixel_distill_pretrain_stage1_4gpu.yaml

echo "Running UniLIP Dual Stream with Pixel Distillation (ImageNet) on 4 GPUs"
