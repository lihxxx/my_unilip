#!/bin/bash
# UniLIP PS-VAE Stage 2 448px (ImageNet): Training with Semantic AE at higher resolution
# 目标: 448px ImageNet 图像重建 + 特征蒸馏 + PS-VAE语义重建
# 
...
config_file=./configs/training/InternVL3_1B_DCAE/internvl3_1B_psvae_stage2_448_imagenet.yaml

echo "Running UniLIP PS-VAE Stage 2 448px (ImageNet) on Node $RANK / $WORLD_SIZE (Master: $MASTER_ADDR:$MASTER_PORT)"
